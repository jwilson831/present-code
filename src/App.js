              ...
              <br/>
                ...
                <Route exact path="/CSR">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      2105, 2103, 1838, 1800, 1325, 580, 177, 181, 184, 590, 601, 616, 599, 3613, 2560, 2572, 2394, 2380, 2319, 2325, 2226,
                      2132, 2150, 1862
                    ]}
                    comments={comments}
                    changeActiveCategory={changeActiveCategory}
                ...
                <Route exact path="/cyber">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      1337, 1319, 1309, 215, 218, 3607, 3605, 3602, 2671, 2678, 2332, 2335, 2250, 1947, 187,
                      1306
                    ]}
                    comments={comments}
                    changeActiveCategory={changeActiveCategory}
