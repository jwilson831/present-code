        ...
        >
            <div className="modal-dialog poll-dialog" role="document">
                ...
                <div className="modal-body poll-body text-center">
                    <iframe title="poll" id="totalpoll-iframe-2645" src="https://skytop-strategies.com/?post_type=poll&p=2645&embed=1" frameborder="0" allowtransparency="true" width="100%" height="600"></iframe>
                </div>
