              ...
              <div className="section">
                ...
                <Route exact path="/activism">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      3594, 3560, 3626, 3623, 2751, 2748, 2744, 2569, 2661, 2241,
                ...
                <Route exact path="/investment">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      3089, 2756, 2675, 2424, 2157, 1804, 203, 622, 583, 3620
                    ]}
                    comments={comments}
                    changeActiveCategory={changeActiveCategory}
                    ad_link={"https://www.boardroomalpha.com/"}
                ...
                <Route exact path="/CSR">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      3613, 2560, 2572, 2394, 2380, 2319, 2325, 2226,
                      2132, 2150, 1862
                    ]}
                    comments={comments}
                    changeActiveCategory={changeActiveCategory}
                ...
                <Route exact path="/cyber">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      3607, 3605, 3602, 2671, 2678, 2332, 2335, 2250, 1947, 187,
                      1306
                    ]}
                    comments={comments}
                    changeActiveCategory={changeActiveCategory}
                ...
                <Route exact path="/capital-markets">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      3596, 2894, 2588, 2407, 2430, 2223, 2153, 2145, 1808, 1303, 585
                    ]}
                    comments={comments}
                    changeActiveCategory={changeActiveCategory}
                    ad_link={"https://www.boardroomalpha.com/"}
                ...
                <Route exact path="/washington-world">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      3593, 3609, 3616, 3617, 2753, 2757, 2754, 2637, 2574,
