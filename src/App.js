              ...
              <br/>
                ...
                <Route exact path="/activism">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                        1328, 1322, 593, 596, 627, 205, 209, 212, 3594, 3560, 3626, 3623, 2751, 2748, 2744, 2569, 2661, 2241,
                ...
                <Route exact path="/investment">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      2555, 197, 200, 607, 3089, 2756, 2675, 2424, 2157, 1804, 203, 622, 583, 3620
                    ]}
                    comments={comments}
                    changeActiveCategory={changeActiveCategory}
                    ad_link={"https://www.boardroomalpha.com/"}
                ...
                <Route exact path="/CSR">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      4168, 2105, 2103, 1838, 1800, 1325, 580, 177, 181, 184, 590, 601, 616, 599, 3613, 2560, 2572, 2394, 2380, 2319, 2325, 2226,
                      2132, 2150, 1862
                    ]}
                    comments={comments}
                    changeActiveCategory={changeActiveCategory}
                ...
                <Route exact path="/washington-world">
                  <Section
                    ...
                    articles={articles}
                    ids={[
                      4142, 2557, 1314, 1290, 612, 193, 609, 604, 3593, 3609, 3616, 3617, 2753, 2757, 2754, 2637, 2574,
