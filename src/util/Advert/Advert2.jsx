function Advert2(props) {
  return (
    <div id="border">
      <a href="https://skytopstrategies.com/authors/4413" target="_blank" rel="noreferrer">
        <div className="advertRow">
          <div className="advertColumn">
            <img
              className="soldierImg"
              src="https://skytop-strategies.com/wp-content/uploads/2022/07/Tim-Chrisman.jpg"
              alt="ad"
            />
          </div>
